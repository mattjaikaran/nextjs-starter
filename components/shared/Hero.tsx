...
export function Hero({
  ...
  description =
    'A modern, scalable Next.js application boilerplate built with App Router, TypeScript, and the latest development tools.',
  primaryAction = {
    label: 'Get Started',
    href: '/auth/register',
  },
  secondaryAction = {
    ...
    href: 'https://github.com/mattjaikaran/nextjs-starter',
  },
}: HeroProps) {
  return (
          ...
          <div className="mx-auto grid max-w-4xl grid-cols-1 gap-8 pt-16 md:grid-cols-3">
            <div className="space-y-3 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Built with Next.js for fast page loads and optimized production
                builds
              </p>
            </div>
